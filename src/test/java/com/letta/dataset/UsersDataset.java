...
public final class UsersDataset {
	...
	public static User[] users() {
		return new User[] {
			new User(adminLogin(), "713bfda78870bf9d1b261f565286f85e97ee614efe5f0faf7c34e7ca4f65baca", "ADMIN", "admin@admin.com"),
			new User(normalLogin(), "7bf24d6ca2242430343ab7e3efb89559a47784eea1123be989c1b2fb2ef66e83", "USER", "user@user.com")
		};
	}
